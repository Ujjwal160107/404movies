...
const MovieCard = ({ movie }) => {
    return (
        <div className="group relative flex-shrink-0 w-[200px] h-[300px] rounded-lg overflow-hidden cursor-pointer transition-transform hover:scale-105 hover:z-10">
            <img
                src={movie.poster}
                alt={movie.title}
            ...
            <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-center items-center p-4 text-center">
                ...
                <button className="bg-white text-black rounded-full p-3 mb-4 hover:bg-accent hover:text-white transition-colors">
